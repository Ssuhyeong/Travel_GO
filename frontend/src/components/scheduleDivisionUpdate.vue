<template>
  <div class="steps" id="steps">
    ...
    <button
      class="plus_btn"
      style="min-width: 40px; border-radius: 50px"
      v-if="active_count != 7"
      @click="plusActive">
      +
    </button>
